...
# --- Configuration ---     
USE_GUI = False    
CHECKPOINT_PATH = "../Outputs/ray_results/PPO_LSTM_0/PPO_PPO_9a3c7_00000_0_2025-08-20_20-23-58/checkpoint_000190--86"    
COMPARISON_DIR = "../Results/LSTM"    
...
def run_ai_evaluation_all_scenarios():      
    ...
    # Registrar el entorno (igual que antes)  
    ...
    for scenario in range(1, NUM_SCENARIOS + 1):      
        ...
        # CAMBIO PRINCIPAL: Inicializar estados LSTM para cada agente  
        lstm_states = {}  
        for agent_id in obs_dict.keys():  
            lstm_states[agent_id] = algo.get_policy().get_initial_state()  
        ...
        while not done:      
            ...
            for agent_id, agent_obs in obs_dict.items():      
                # CAMBIO PRINCIPAL: Pasar el estado LSTM  
                action, lstm_states[agent_id], _ = algo.compute_single_action(      
                    observation=agent_obs,      
                    state=lstm_states[agent_id],  # Pasar estado LSTM  
                    policy_id="default_policy",      
                    explore=False  # Evaluación determinística  
                )      
...
def generate_scenario_based_plots_with_ci(df_combined, output_dir):    
    ...
    for i, (metric_name, metric_data) in enumerate(metrics.items(), 1):    
        ...
        labels = ['Semáforos Tradicionales', 'Modelo IA (PPO-LSTM)']    
